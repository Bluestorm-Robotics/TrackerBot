...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      Auton("Drive_example\n This is a example driving program that we will learn to modify", drive_example),
      Auton("Turn Example\n This is a example turning program that we will learn to modify", turn_example),
      Auton("My First Program\n This is a blank program that YOU will create :)", myFirstProgram),
  });
